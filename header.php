			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-5 right">
						<div class="dropdown">
							<a href="#"><?php esc_html_e('Київ ', 'understrap'); ?><img class="icon-r" src="<?php echo get_template_directory_uri();?>/img/dropdown.svg" alt="Logo"></a>
							<div class="dropdown-content">
								<ul class="dropdownli">
								<li><a href="#"><?php esc_html_e('Київ ', 'understrap'); ?></a></li>
								<li><a href="#"><?php esc_html_e('Амвросіївка ', 'understrap'); ?></a></li>
								<li><a href="#"><?php esc_html_e('Апостолове ', 'understrap'); ?></a></li>
								<li><a href="#"><?php esc_html_e('Армянськ ', 'understrap'); ?></a></li>
								</ul>
							</div>
						</div>
						...
						<div class="header-callback">
							<a href="tel:+380958295001"><img class="icon-l icon-callback" src="<?php echo get_template_directory_uri();?>/img/callback-icon.png"><span><?php esc_html_e('зворотний дзвінок', 'understrap'); ?></span></a>
						</div>
					</div>
				</div>
			</div>
